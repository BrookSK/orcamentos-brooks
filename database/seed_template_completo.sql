-- ========================================
-- SEED COMPLETO: Template Orçamento Casa Ana e Caio
...
-- Limpar dados anteriores se necessário (CUIDADO: isso remove TODOS os orçamentos!)
-- DELETE FROM orcamentos WHERE numero_proposta LIKE '%CASA ANA E CAIO%';
...
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MATERIAL / CUSTO PREVISTO', '1.4.3', 'LOCAÇÃO PROVISÓRIA', 1.000, 'vb', 2750.00, 2750.00, 2750.00, 0.00, 2750.00, 0.00, 0.00, 5),
...
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MATERIAL / CUSTO PREVISTO', '1.8.4', 'PORTÃO PARA VEÍCULOS', 1.000, 'unid', 423.50, 423.50, 423.50, 0.00, 423.50, 0.00, 0.00, 15),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MATERIAL / CUSTO PREVISTO', '1.8.5', 'PORTÃO PARA PEDESTRES', 1.000, 'unid', 319.00, 319.00, 319.00, 0.00, 319.00, 0.00, 0.00, 16),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.4.1', 'MÃO DE OBRA MONTAGEM DE CANTEIRO', 50.000, 'm2', 132.00, 6600.00, 0.00, 6600.00, 6600.00, 0.00, 0.00, 17),
...
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.4.4', 'PROJETO DO CANTEIRO', 1.000, 'vb', 2200.00, 2200.00, 0.00, 2200.00, 2200.00, 0.00, 0.00, 19),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.5.3', 'ALUGUEL DE ANDAIMES', 1.000, 'vb', 2585.00, 2585.00, 0.00, 2585.00, 2585.00, 0.00, 0.00, 20),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.6.1', 'DATABOOK / MANUAL DO PROPRIETÁRIO', 1.000, 'vb', 8800.00, 8800.00, 0.00, 8800.00, 8800.00, 0.00, 0.00, 21),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.7.3', 'MÃO DE OBRA PARA REMOÇÃO DE ENTULHO', 18.000, 'm²s', 440.00, 7920.00, 0.00, 7920.00, 7920.00, 0.00, 0.00, 22),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.8.2', 'MÃO DE OBRA PARA MONTAGEM DE TAPUME', 462.000, 'm2', 38.50, 17787.00, 0.00, 17787.00, 17787.00, 0.00, 0.00, 23),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.8.4', 'PORTÃO PARA VEÍCULOS', 1.000, 'unid', 423.50, 423.50, 0.00, 423.50, 423.50, 0.00, 0.00, 24),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.8.5', 'PORTÃO PARA PEDESTRES', 1.000, 'unid', 319.00, 319.00, 0.00, 319.00, 319.00, 0.00, 0.00, 25),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.9.1', 'CONTROLE TECNOLÓGICO DO CONCRETO', 13.000, 'vb', 550.00, 7150.00, 0.00, 7150.00, 7150.00, 0.00, 0.00, 26),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.10.2', 'FRETE', 1.000, 'vb', 1760.00, 1760.00, 0.00, 1760.00, 1760.00, 0.00, 0.00, 27),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.11.2', 'ACOMPANHAMENTO GEOTÉCNICO PARA FUNDAÇÕES', 1.000, 'vb', 16500.00, 16500.00, 0.00, 16500.00, 16500.00, 0.00, 0.00, 28),
(@orcamento_id, 'ETAPA CINZA (BRUTA)', 'SERVIÇOS INICIAIS', 'MÃO DE OBRA / CUSTO EFETIVO', '1.12.2', 'CONSULTORIA TÉCNICA PARA CONCRETO APARENTE', 1.000, 'vb', 5280.00, 5280.00, 0.00, 5280.00, 5280.00, 0.00, 0.00, 29);

-- Categoria: LOCAÇÃO / DEMARCAÇÃO DE OBRA + TOPOGRAFIA
INSERT INTO `orcamento_itens` (`orcamento_id`, `etapa`, `grupo`, `categoria`, `codigo`, `descricao`, `quantidade`, `unidade`, `valor_unitario`, `valor_total`, `custo_material`, `custo_mao_obra`, `valor_cobranca`, `margem_lucro`, `desconto_item`, `ordem`) VALUES
...
SELECT 
    ...
    'Template criado com sucesso!' as 'Status',
