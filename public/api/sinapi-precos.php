 ...
 * 
 * GET /api/sinapi-precos.php?codigo=1379&uf=SP
 * GET /api/sinapi-precos.php?codigos=1379,1106,370&uf=SP
 * GET /api/sinapi-precos.php?listar=1&termo=cimento&uf=SP
 */
...
try {
    ...
    echo json_encode([
        ...
        'uso' => [
            'buscar_um' => '/api/sinapi-precos.php?codigo=1379&uf=SP',
            'buscar_varios' => '/api/sinapi-precos.php?codigos=1379,1106,370&uf=SP',
            'listar' => '/api/sinapi-precos.php?listar=1&termo=cimento&uf=SP'
        ]
    ], JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
